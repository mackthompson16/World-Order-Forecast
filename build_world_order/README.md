...
- Competitiveness = norm(polity)

## Data supplementation for metrics
- Forward-fill inputs per country over time if gap < 4
- If gap > 3, use linear interpolation to fill in data.
- Do not extend before first or past last data point.
